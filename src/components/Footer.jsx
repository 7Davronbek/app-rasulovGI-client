...
const Footer = () => {
    return (
        <>
            ...
            <div className="koko">
                <a target={'_blank'}  rel="noreferrer" href="https://kokoagency.uz/">© 2022 Aro. All rights reserved.</a>
            </div>
        </>
    )
}
